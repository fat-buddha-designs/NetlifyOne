<template>
  <Layout>
    <section>
      <h2 data-aos="fade-in" data-aos-delay="100" data-aos-offset="50" data-aos-easing="ease-in-sine" data-aos-duration="2500">The {{ $static.metadata.company }} Brand</h2>
      <g-image class="full--width" src="~/assets/img/brand.jpg" alt="image"/>
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error doloremque omnis animi, eligendi magni a voluptatum, vitae,
...
export default {
  metaInfo() {
    return {
      title: 'The Medium Brand',
      link: [{
        rel: 'canonical',
        href: 'https://medium.co.uk/brand'
      }],
      meta: [{
          name: 'description',
        ...
        {
          property: 'og:url',
          content: 'https://medium.co.uk/brand',
        },
        {
          property: 'og:title',
          content: 'The Medium Brand',
        },
        {
      ...
      script: [{
        ...
        json: {
          ...
          '@type': 'LocalBusiness',
          'name': 'Medium',
          'url': 'https://www.medium.co.uk/brand',
