...
export default {
  metaInfo() {
    return {
      title: 'How Netlify-One Develop',
      link: [
        {
          rel: 'canonical',
          href: 'https://netlify-one.co.uk/develop',
          hreflang: 'en-GB',
        },
      ],
      meta: [
        ...
        {
          property: 'og:url',
          content: 'https://netlify-one.co.uk/develop',
        },
        {
          property: 'og:title',
          content: 'How Netlify-One Develop',
        },
        {
      ...
      script: [
        {
          ...
          json: {
            ...
            '@type': 'LocalBusiness',
            name: 'Netlify-One',
            url: 'https://www.netlify-one.co.uk/develop',
