<template>
  <Layout>
    <section>
      <h2 data-aos="fade-in" data-aos-delay="100" data-aos-offset="50" data-aos-easing="ease-in-sine" data-aos-duration="2500">{{ $static.metadata.company }}'s Designs</h2>
...
export default {
  metaInfo() {
    return {
      title: 'Mediums Designs',
      link: [{
        rel: 'canonical',
        href: 'https://medium.co.uk/design'
      }],
      meta: [{
          name: 'description',
        ...
        {
          property: 'og:url',
          content: 'https://medium.co.uk/design',
        },
        {
          property: 'og:title',
          content: 'Mediums Designs',
        },
        {
      ...
      script: [{
        ...
        json: {
          ...
          '@type': 'LocalBusiness',
          'name': 'Medium',
          'url': 'https://www.medium.co.uk/design',
          'logo': 'https://www.medium.co.uk/assets/img/Logo.jpg',
          'image': 'https://www.medium.co.uk/assets/img/Main-Image.jpg',
